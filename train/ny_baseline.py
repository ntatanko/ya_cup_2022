...
class BaseModel(nn.Module):
    def __init__(
        self, output_features_size1=512, output_features_size2=128, embed_len = 128, kernel_size=3
    ):
        super().__init__()
...
def train(
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            val_ndcg = eval_submission(ranked_list, valset_meta)
...
def main():
    ...
    # python3 ny_baseline.py --base-dir='/app/_data/artist_data/' --save-dir='ny_2_1' --fold=1 --batch-size=512 --n-channels=512 --emb-len=256 --n-epochs=150 --kernel-size=3 --temperature=0.01
    # Seed
    seed = 42
    random.seed(seed)
    np.random.seed(seed)
